...
{}"#,
        ...
        if !patch_crates_io_content_str.is_empty() {
            ...
            // Prepend source file information
            let source_info = format!(
                "# Generated by {} at {}\n# Do not edit this file by hand. Your changes will be overwritten.\n\n",
                file!(),
                chrono::Utc::now().to_rfc3339()
            );
            final_cargo_toml_content = source_info + &final_cargo_toml_content;
    
            let workspace_cargo_toml_path = output_dir.join("Cargo.toml");
            if !dry_run {
                add_generated_header!(&workspace_cargo_toml_path, &final_cargo_toml_content)
