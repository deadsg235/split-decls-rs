// Generated by add_generated_rust_header! macro at submodules/split-decls-rs/src/eager_splitter/declaration_writer.rs:71 from submodules/split-decls-rs/src/eager_splitter/declaration_writer.rs at 2025-12-23T17:27:48.033196898+00:00
// Do not edit this file by hand. Your changes will be overwritten.

use serde::{Deserialize, Serialize};
use std::collections::HashMap;
#[doc = " Clones or updates a Git repository and checks out a specific reference,"]
#[doc = " and sets up origin and upstream remotes."]
pub fn manage_git_repo(
    ...
    let repo_name = target_dir
        ...
        .to_str()
        .context("Repository name is not valid UTF-8")?;
    ...
    if !target_dir.exists() {
        ...
        println!(
            "Repository already exists at {}. Fetching latest...",
            target_dir.display()
        );
        Command::new("git")
            .arg("-C")
